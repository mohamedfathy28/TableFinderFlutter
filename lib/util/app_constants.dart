...
class AppConstants {
  static const String appName = 'Table Finder';
  static const double appVersion = 7.2;

  static const String fontFamily = 'Roboto';
  static const bool payInWevView = false;
  static const String webHostedUrl = 'http://qr.tablefinder.org/';

  static const String baseUrl = 'https://tablefinder.org';
  static const String categoryUri = '/api/v1/categories';
  static const String resCategoryUri = '/api/v1/categories/restaurant/';
  ...
  static const String waitingListUri = '/api/v1/customer/order/WaitingList';
  static const String getResLogo = '/api/v1/customer/order/getlogo';
