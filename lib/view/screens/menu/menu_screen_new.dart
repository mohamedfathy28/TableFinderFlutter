...
import 'package:efood_multivendor/view/screens/scan/reservation/reservation_history_screen.dart';
                    ...
                    child: Column(children: [
                      ...
                      if (Get.find<AuthController>().isLoggedIn())
                        PortionWidget(
                          ...
                          title: 'my_points'.tr,
                          hideDivider: false,
                          route: RouteHelper.getMyPointsRoute(),
                        ),
                      if (Get.find<AuthController>().isLoggedIn())
                        PortionWidget(
                          icon: Images.referIcon,
                          title: 'waiting_list_history'.tr,
                          route: "",
                          onTap: () {
                            ReservationHistoryScreen.navigate(context,
                                isWaitingList: true);
                          },
                        ),
                      if (Get.find<AuthController>().isLoggedIn())
