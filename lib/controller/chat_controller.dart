...
class ChatController extends GetxController implements GetxService {
  ...
  Future<void> getMessages(int offset, NotificationBody? notificationBody,
    ...
    if (!isDelayingForGettingMessages) {
      isDelayingForGettingMessages = true;
      Future.delayed(
        const Duration(seconds: 5),
        () {
          isDelayingForGettingMessages = false;
          return getMessages(offset, notificationBody, user, conversationID);
        },
      );
    }
    update();
  ...
  bool isDelayingForGettingMessages = false;
